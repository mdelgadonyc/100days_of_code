...
# TODO: Populate your copy of the Google Sheet with International Air Transport Association (IATA) codes for each city

manager = data_manager.DataManager
print(manager.get_cities())

flight = flight_search.FlightSearch

for city in manager.get_cities():
    print(flight.get_code(city))
